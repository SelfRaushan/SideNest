...
const Home = () => {
  ...
  const [formStatus, setFormStatus] = useState(null); // To display success or error messages
  ...
  return (
    <>
      ...
      <section className={styles.heroForex}>
        <div className={styles.heroContent}>
          ...
          <h1><span>Nest Your Ideas. Build Boldly</span></h1>
          ...
          <div className={styles.heroButtons}>
            <a href="#start" className={`${styles.btn} ${styles.btnOutlineRed}`}>Start Your Business</a>
          </div>
        </div>
      </section>
      ...
      <div className={styles.container}>
        <section className={styles.hero}>
          ...
          <h1 className={styles.title}>We’re Your Business<br />Growth Partner.</h1>
          ...
          <div className={styles.ctaBlock}>
            <a href="tel:+917387392708" className={styles.phoneLink}>📞 +91 738 739 2708</a>
            <div className={styles.ctaText}>Book Free Discovery Call</div>
          </div>
        </section>

        <section className={styles.contactForm}>
          <form id="styles.estimateForm" onSubmit={handleSubmit}>
            <h2>Request A Free Estimate</h2>
            <input type="text" name="name" placeholder="Full Name" value={formData.name} onChange={handleChange} required />
            <input type="email" name="email" placeholder="Active Email" value={formData.email} onChange={handleChange} required />
            ...
            {formStatus && (<div className={styles.formSuccess} style={{ color: formStatus.success ? 'green' : 'red', marginTop: '10px' }} id="formSuccess">{formStatus.message}</div>)}
          </form>
        </section>
      </div>
    ...
    <section id="resources" className={styles.paidResourcesSection}>
        ...
        <div className={styles.resourcesList}>
            <div className={styles.resourceCard}>
                ...
                <p>Course + templates for launch and scaling—business plan builder, checklists, growth roadmap.</p>
                <a href="#" className={`${styles.btn} ${styles.btnOutlineRed}`}>Learn More</a>
            </div>
            <div className={styles.resourceCard}>
        ...
        <p className={styles.resourcesNote}>Instant download, editable resources with lifetime updates.</p>
    </section>
    ...
    <div className={styles.howSteps}>
      <div className={styles.howStep}><span className={styles.stepNum}>1</span>
        <h4>Pick Your Path</h4>
        <p>Choose a kit or request a customized strategy.</p>
      </div>
      <div className={styles.howStep}><span className={styles.stepNum}>2</span>
        <h4>Meet Your Expert</h4>
        <p>1:1 consultation with SideNest strategists.</p>
      </div>
      <div className={styles.howStep}><span className={styles.stepNum}>3</span>
        <h4>Build or Launch</h4>
        <p>We execute your plan, set up tools, hand you the keys.</p>
      </div>
      <div className={styles.howStep}><span className={styles.stepNum}>4</span>
        <h4>Grow & Scale</h4>
  ...
  <section id="pricing" className={styles.pricingSection}>
    ...
    <div className={styles.pricingCards}>
      <div className={styles.pricingCard}>
        ...
        <a href="#" className={`${styles.btn} ${styles.btnOutlineRed}`}>Get Started</a>
      </div>
      <div className={styles.pricingCard}>
        <h3>📊 Strategy Lab</h3>
        ...
        <a href="#" className={`${styles.btn} ${styles.btnOutlineRed}`}>Book a Strategy Session</a>
      </div>
      <div className={styles.pricingCard}>
        <h3>🧠 Pro Build</h3>
        ...
        <a href="#" className={`${styles.btn} ${styles.btnOutlineRed}`}>Schedule Discovery Call</a>
      </div>
    </div>
    <p className={`${styles.pricingNote}`}>International payments accepted. Invoices provided. <a href="#book">Talk to an Expert</a></p>
  </section>
  ...
  <section className={styles.workShowcase}>
    ...
    <p className={styles.workDesc}>
      Get top-tier results, proven growth strategies, and unmatched execution.<br />
  ...
  <section className={styles.ctaSection} id="book">
    ...
    <div className={styles.ctaButtons}>
      <a href="#" className={styles.ctaBtn + ' ' + styles.ctaPrimary}>📞 Book Free Strategy Call</a>
      <a href="#" className={styles.ctaBtn + ' ' + styles.ctaSecondary}>🚀 Explore Ready Kits</a>
    </div>
  </section>
  {/* FOOTER */}
    </>
